export const ProjectData = [
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            ...
            management of environmental and volunteer related activities across
            various plant stores and institutions.
          </li>
          <li>
          ...
          <li>
            The dashboard features a clean, responsive interface and role-based
            access control, allowing only designated users to perform sensitive
            actions such as editing data or viewing analytics.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            institution handling, while assistant admins can manage content and
            volunteers.
          </li>
          <li>
          ...
          <li>
            Institutional Management: Admins can add and update institutions and
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            <p className="ml-16">useRef: For DOM access and form management.</p>
            <p className="ml-16">
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            The platform supports seamless interaction between different roles,
            ensuring transparency, accountability, and engagement throughout the
            tree planting lifecycle.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">✨ Key Features:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            <p className="ml-16 my-2">
              View assigned trees, update their status to &ldquo;done&ldquo;, or
              choose to accept or reject trees assigned by plant stores.
            </p>
            <p className="ml-16 my-2">
          ...
          <li>
            ...
            <p className="ml-16 my-2">
              Access a profile page with their rating and a detailed log of all
              past activity.
            </p>
          </li>
        </ul>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            NativeWind (Tailwind for React Native): Enables clean, responsive UI
            design with utility-first styling.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Building a real-time tree assignment system that allows both manual
            and self-assignment.
          </li>
          <li>
        ...
        <p className="mt-4 text-slate-100">Note:</p>
        <p className="px-2 mt-2 ml-2">
          you can test the app and the dashboard just send me a message to send
          you a valid email and password for that
        </p>
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        <p className="mt-4 text-primary-500">Organizations Management System</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
          ...
          <li>
            This system enables centralized administration while also empowering
            each organization with the tools needed to manage their own
            initiatives, address user feedback, and evaluate public engagement
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            user-submitted problems, suggestions, and surveys specific to their
            projects, supporting responsive and people-centered development.
          </li>
          <li>
            Statistics Dashboard: Admins have access to visual insights and key
            metrics across all organizations and projects for informed
            decision-making.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            suggestions, and surveys) per project while maintaining clarity and
            organization.
          </li>
          <li>
            Ensuring high usability and accessibility across multiple roles and
            platforms.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">Note:</p>
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            and improvement of public and private sector projects by submitting
            surveys, suggestions, and reports on encountered issues.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            Encourages civic participation by giving users a voice in local and
            national projects.
          </li>
          <li>
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>react-router-dom: Manages seamless navigation between pages.</li>
          <li>
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            aesthetic appeal, enabling developers, designers, and freelancers to
          ...
          <li>
            Built with modern web standards, this template ensures compatibility
            across different devices and screen sizes, making your portfolio
            accessible and engaging on mobile, tablet, and desktop.
          </li>
          <li>
            Its structure emphasizes readability, intuitive navigation, and
            polished design elements that help create a strong first impression
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            React.js: Component-based architecture for building fast, scalable,
            and interactive user interfaces
          </li>
          <li>
            Vite: Modern build tool providing ultra-fast development server and
  ...
  },
  {
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            Bilingual Support: Full support for Arabic and English languages to
            accommodate a diverse user base.
          </li>
          <li>
            Secure Payments: Integrated electronic payment gateway for quick and
            secure transactions.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>react-icon: Adds icons for a more intuitive user experience.</li>
          <li>react-router-dom: Manages seamless navigation between pages.</li>
          <li>
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            ...
            items to the store. The system calculates the price with and without
            profit, helping businesses track their earnings.
          </li>
          <li>
            Profit Calculation: Automatic monthly profit calculation based on
            sales. Every transaction is recorded and contributes to the overall
            profit report.
          </li>
          <li>
          ...
          <li>
            Editable Items: Users can adjust the quantity and prices of items to
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            Real-Time Inventory and Cash Tracking: Ensuring accurate updates to
            inventory levels and cashbox amounts in real time.
          </li>
          <li>
  ...
  },
  {
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            React Native Expo: Ensures cross-platform compatibility and ease of
            development.
          </li>
          ...
          <li>useFonts: Adds custom fonts to enhance the app’s appearance.</li>
          <li>
          ...
          <li>nativewind: For styling and ensuring a responsive, modern UI.</li>
        </ul>
      </div>
    ),
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            incorporates various modern technologies to ensure speed, security,
            and scalability.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">✨ Key Features:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Profile Management: Users can edit their profile settings, ensuring
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Node.js & Express.js: Backend for managing user data, messaging, and
            API requests.
          </li>
          <li>
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Real-Time Location Tracking: Both clients and drivers can view each
            other’s locations on a map during a trip.
          </li>
          <li>
            Trip Management: Clients can select a destination, see the estimated
            cost, and track the driver’s location. Drivers can mark trips as
            completed, enabling them to receive new requests.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Maps Integration: Allows real-time location tracking and destination
            selection for clients and drivers.
          </li>
          <li>useContext: Manages global state across different components.</li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            searching to trip completion, while maintaining smooth interactions
            between clients and drivers.
          </li>
          <li>
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Clients can browse tours, view key details such as dates, locations,
            and pricing, and easily connect with trip organizers for booking.
          </li>
          <li>
            The platform also provides personalized tour recommendations based
            on users’ previous bookings, ensuring a tailored travel experience.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">✨ Key Features:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            allowing users to switch between languages via i18-next integration.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">🛠 Tech Stack:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Seamless Booking: Ensuring smooth and intuitive interactions between
            clients and organizers for a hassle-free booking experience.
          </li>
          <li>
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            ...
            design company, offering a sleek and visually appealing platform for
            potential clients to explore their work and connect via social
            media.
          </li>
          <li>
            The website is designed with a strong focus on aesthetics and user
            experience, ensuring that visitors can easily navigate and discover
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Social Media Integration: Direct links to the company’s social media
            accounts, allowing visitors to follow and connect with the brand.
          </li>
          <li>
  ...
  },
  {
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            A fully interactive and intuitive image editing web application that
            empowers users to upload and transform their images with precision
            and ease.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            <p className="ml-16 my-2">Rotate (Clockwise & Counter-Clockwise)</p>
          </li>
          <li>
            <p>Cropping Tool:</p>
            <p className="ml-16 my-2">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Tailwind CSS: Enables clean and responsive design with utility-first
            styling.
          </li>
          <li>
            Built-in React Hooks (useState, useEffect, useRef, useMemo): Manage
            state, DOM interactions, and performance efficiently.
          </li>
        </ul>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            depth, providing an accessible solution for image editing that runs
            entirely in the browser no installations required.
          </li>
        </ul>
      </div>
    ),
      ...
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            ...
            experience by transforming standard PDF files into student-friendly
            note-taking layouts.
          </li>
          <li>
            ...
            create clean, empty spaces for handwritten or typed notes—ideal for
            lectures, study sessions, and interactive learning.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">✨ Key Features:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            React Hooks (useState, useEffect, useRef): Manage state, lifecycle,
            and DOM manipulation effectively.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">🎯 Purpose & Impact:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
  ...
  },
  {
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            A modern React.js-based web application tailored for dental clinics
            to streamline patient management, enhance service visibility, and
            optimize daily workflows for doctors and their assistants.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            Patient Account Management: Doctor assistants can create and manage
            patient profiles, input treatment details, and update personal and
            medical information.
          </li>
          <li>
            Doctor&apos;s Daily View: Doctors can easily view a list of
            scheduled patients for each day, with quick access to their medical
            histories and current treatment plans.
          </li>
          <li>
            Clinic Overview: Detailed sections providing an overview of the
            clinic, including doctors&apos; profiles, qualifications, and areas
            of expertise.
          </li>
          <li>
          ...
          <li>
            Responsive & User-Friendly Design: Clean, mobile-friendly UI ensures
            seamless use on tablets, desktops, or at reception desks.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">🛠 Tech Stack:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            Zustand: Lightweight state management for scalable and efficient app
            behavior.
          </li>
          <li>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            It demonstrates strong UX thinking, solid form and data management,
            and effective role-based UI behavior for medical workflows.
          </li>
        </ul>
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <div className="flex w-full md:pl-4 flex-col">
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            A full-featured React.js web application that democratizes access to
            GPT-3.5 by enabling flexible payment options and integrating
            Telegram for mobile AI interaction.
          </li>
          <li>
            Designed for global users—especially those without access to
            traditional online payment methods—this platform provides a seamless
            experience to subscribe, interact, and benefit from powerful AI
            tools.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">✨ Key Features:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>
            ...
            <p className="ml-16 my-2">
              ...
              ensuring accessibility and ease of use without needing to stay on
              the website.
            </p>
          </li>
          <li>
            ...
            <p className="ml-16 my-2">
              Public review section allows users to read others experiences and
              build trust.
            </p>
          </li>
          <li>
            <p>Responsive Design:</p>
            <p className="ml-16 my-2">
              Fully optimized for desktop and mobile, making it accessible from
              any device.
            </p>
          </li>
        </ul>
        ...
        <ul className="list-disc px-2 mt-2 ml-2">
          ...
          <li>Zustand: Simple yet powerful state management across the app.</li>
          <li>
            React Hook Form: Provides robust form handling for payments,
            uploads, and user feedback.
          </li>
          <li>
            Built-in React Hooks (useState, useEffect, useRef, etc.): Optimized
            interaction handling and performance.
          </li>
        </ul>
        <p className="mt-4 text-slate-100">🎯 Purpose & Impact:</p>
        <ul className="list-disc px-2 mt-2 ml-2">
          <li>
            This project empowers users from underbanked regions to gain access
            to advanced AI tools through inclusive payment options and
